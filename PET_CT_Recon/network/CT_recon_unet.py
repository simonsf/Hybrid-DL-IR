...
def net_profile():
    ...
    # input = torch.randn(1, 1, 1, 2592, 1904)
    input = torch.randn(1, 5, 512, 512)
    # input = torch.randn(1, 1, 1296, 952)

    net = MIRNet(5, 1, n_RRG=2)
    print(net)
